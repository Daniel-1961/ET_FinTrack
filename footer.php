    ...
    <script>
        ...
        const globalTranslations = {
            en: {
                ...
                menu_products: "Inventory",
                products_subtitle: "Add, update, and organize your products to easily track stock levels.",
                btn_add_product: "Add Product",
                table_product_name: "Product Name",
                table_stock: "Stock Level",
                table_price: "Price",
                badge_low_stock: "Low Stock",
                badge_in_stock: "In Stock",
                drawer_add_product: "Add Product",
                form_product_name: "Product Name",
                form_product_price: "Price (ETB)",
                form_product_quantity: "Initial Quantity",
                btn_save_product: "Save Product",
                form_sale_product: "Select Product from Inventory",
            ...
            am: {
                ...
                menu_products: "ዕቃዎች / ስቶክ",
                products_subtitle: "ዕቃዎችን ይመዝግቡ፣ ዋጋ ያስተካክሉ፣ እና የዕቃዎችን ክምችት ይከታተሉ።",
                btn_add_product: "አዲስ ዕቃ መዝግብ",
                table_product_name: "የዕቃው ስም",
                table_stock: "ያለው ብዛት",
                table_price: "ዋጋ",
                badge_low_stock: "ሊያልቅ ነው",
                badge_in_stock: "በቂ ክምችት አለ",
                drawer_add_product: "አዲስ ዕቃ መመዝገቢያ",
                form_product_name: "የዕቃው ስም",
                form_product_price: "ዋጋ (ብር)",
                form_product_quantity: "የመጀመሪያ ብዛት",
                btn_save_product: "ዕቃውን መዝግብ",
                form_sale_product: "ከስቶክ ውስጥ ዕቃ ይምረጡ",
